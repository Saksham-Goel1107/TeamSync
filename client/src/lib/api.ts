...
export const removeMemberMutationFn = async ({
  ...
  const response = await API.post(`/member/workspace/${workspaceId}/remove`, {
    memberId,
  });
  return response.data;
};
...
export const leaveWorkspaceMutationFn = async (
  ...
  const response = await API.post(`/member/workspace/${workspaceId}/leave`);
  return response.data;
};

export const transferWorkspaceOwnershipMutationFn = async ({
  workspaceId,
  newOwnerId,
}: {
  workspaceId: string;
  ...
  const response = await API.post(
    `/member/workspace/${workspaceId}/transfer-ownership`,
    {
      newOwnerId,
    }
  );
...
export const regenerateInviteCodeMutationFn = async (workspaceId: string) => {
  const response = await API.post(`/workspace/${workspaceId}/regenerate-invite`);
  return response.data;
};
